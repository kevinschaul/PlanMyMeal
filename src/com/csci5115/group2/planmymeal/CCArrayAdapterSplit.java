...
public class CCArrayAdapterSplit extends ArrayAdapter<Cookable> {
	...
	public CCArrayAdapterSplit(Context context, List<Cookable> cookables) {
		super(context, R.layout.row_cc_cookable_split, cookables);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    View rowView = inflater.inflate(R.layout.row_cc_cookable_split, parent, false);
	    TextView mealType = (TextView) rowView.findViewById(R.id.row_cc_meal_split_listCookableType);
	    TextView mealName = (TextView) rowView.findViewById(R.id.row_cc_meal_split_listCookableName);
	    TextView mealTime = (TextView) rowView.findViewById(R.id.row_cc_meal_split_listCookableTime);
